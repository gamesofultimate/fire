...
use engine::application::components::{SelfComponent, PhysicsComponent};
...
impl Behavior for Follow {
    fn run(&mut self, entity: Entity, scene: &mut Scene, backpack: &mut Backpack, _: &mut Backpack) -> Status {
